...
* **[Data Preparation](analysis/01_preprocessing.ipynb)**: Load and format images, cell boundaries (e.g., Xenium outputs).

* **[Image Registration](analysis/02_registration.ipynb)**: Automatic alignment using SimpleITK.

* **[Transformation](analysis/02_transformation.ipynb)**: Map spatial annotations (such as cell boundaries) into the target coordinate system.

* **[Validation](analysis/03_validation.ipynb)**:  Validate the result using IoU and distance error against ground truth segmentation.